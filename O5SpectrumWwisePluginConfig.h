...
#ifndef O5SpectrumWwisePluginConfig_H
#define O5SpectrumWwisePluginConfig_H
...
namespace O5SpectrumWwisePluginConfig
{
    static const unsigned short CompanyID = 64;
    static const unsigned short PluginID = 3610;
}

#endif // O5SpectrumWwisePluginConfig_H
