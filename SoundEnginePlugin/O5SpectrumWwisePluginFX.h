...
#ifndef O5SpectrumWwisePluginFX_H
#define O5SpectrumWwisePluginFX_H
...
class O5SpectrumWwisePluginFX
    : public AK::IAkInPlaceEffectPlugin
{
public:
    O5SpectrumWwisePluginFX();
    ~O5SpectrumWwisePluginFX();
...
private:
    O5SpectrumWwisePluginFXParams* m_pParams;
    AK::IAkPluginMemAlloc* m_pAllocator;
    AK::IAkEffectPluginContext* m_pContext;
};

#endif // O5SpectrumWwisePluginFX_H
