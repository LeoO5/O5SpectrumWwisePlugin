...
#ifndef O5SpectrumWwisePluginFXParams_H
#define O5SpectrumWwisePluginFXParams_H
...
struct O5SpectrumWwisePluginRTPCParams
{
    AkReal32 fPlaceholder;
};

struct O5SpectrumWwisePluginNonRTPCParams
{
};

struct O5SpectrumWwisePluginFXParams
    : public AK::IAkPluginParam
{
    O5SpectrumWwisePluginFXParams();
    O5SpectrumWwisePluginFXParams(const O5SpectrumWwisePluginFXParams& in_rParams);
    ...
    O5SpectrumWwisePluginRTPCParams RTPC;
    O5SpectrumWwisePluginNonRTPCParams NonRTPC;
};

#endif // O5SpectrumWwisePluginFXParams_H
