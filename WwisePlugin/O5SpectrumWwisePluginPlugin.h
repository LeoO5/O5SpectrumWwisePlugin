...
class O5SpectrumWwisePluginPlugin final
    : public AK::Wwise::Plugin::AudioPlugin
{
public:
    O5SpectrumWwisePluginPlugin();
    ~O5SpectrumWwisePluginPlugin();
...
AK_DECLARE_PLUGIN_CONTAINER(O5SpectrumWwisePlugin);	// Exposes our PluginContainer structure that contains the info for our plugin
