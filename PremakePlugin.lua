...
local Plugin = {}
Plugin.name = "O5SpectrumWwisePlugin"
Plugin.factoryheader = "../SoundEnginePlugin/O5SpectrumWwisePluginFXFactory.h"
Plugin.appleteamid = ""
Plugin.signtoolargs = {}
Plugin.sdk = {}
Plugin.sdk.static = {}
...
{
    "O5SpectrumWwisePluginFXShared.cpp"
}
...
{
    "O5SpectrumWwisePluginFXShared.cpp",
    "O5SpectrumWwisePluginFXFactory.h",
}
...
Plugin.authoring.files =
{
    ...
    "**.hpp",
    "**.c",
    "O5SpectrumWwisePlugin.def",
    "O5SpectrumWwisePlugin.xml",
    "**.rc",
}
